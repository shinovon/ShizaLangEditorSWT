...
public class ZipOutputStream extends DeflaterOutputStream implements ZipConstants
{
  ...
  public void closeEntry() throws IOException
  {
    ...
    if (curEntry.getCrc() < 0)
      curEntry.setCrc(crc.getValue());
    	...
    	throw new ZipException("crc was " + toHexString(this.crc.getValue()) + ", but I expected " + toHexString(this.curEntry.getCrc()));
     offset += csize;
  ...
  private static String toHexString(long n) {
      if (n >= 0L && (int)n == n) {
      ...
      int n2 = 64;
      do {
          array[--n2] = ZipOutputStream.hexChars[(int)n & 0xF];
      } while ((n >>>= 4) != 0L);
      return new String(array, n2, 64 - n2);
  }
